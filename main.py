"""
Command line game module written in python.
Provided by the Yandex workshop team for educational purposes.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Return the degree of damage to the enemy.
...
def defence(char_name: str, char_class: str) -> str:
    """Return the success of repelling enemy attacks.
    Depending on the role of the participant.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Start the game.
    Displays the features of the selected character.
    """
    if char_class == 'warrior':
